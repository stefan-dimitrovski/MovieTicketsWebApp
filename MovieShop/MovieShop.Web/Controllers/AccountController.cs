...
namespace EShop.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<MovieShopApplicationUser> signInManager;
        public AccountController(UserManager<MovieShopApplicationUser> userManager, SignInManager<MovieShopApplicationUser> signInManager)
        {
